...
<div id="averespcircle"	style="text-align: center; background: <%=clr_av%>;"><br>
...
<div id="appcrashcircle" style="text-align: center;  background: <%=clr_c%>;"><br>
...
<div id="extra">
	...
	<%}catch(Exception e){
	System.out.println("Exception Caught inside onlyuser.jsp");
} %>
</div>
