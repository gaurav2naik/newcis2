...
<body>
	<div style="width: 99%; color: red;">
		...
		<br>
		 <div id="container3"
			style="width: 45%; margin-right : 2.5%; height: 225px; margin-left : 2.5%; float: left; align: left">
		</div>
		<div id="container4"
 ...
 -->
		 <div id="container1"
			style="align: left;width: 45%; margin-right : 2.5%;  height: 225px; margin-left : 2.5%; float: left; padding-top: 0px;"></div> 
		 <div id="container5"
