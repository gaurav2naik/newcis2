...
public class SMS {
	...
	public static void main(String[] args) {
	    ...
	    final String API_KEY = "ad05555f";
	     final String API_SECRET = "08162a3e";

	    final String SMS_FROM = "Avekshaa-CIS";
	   final String SMS_TO = "+919449044203";
...
/*public class dummy {
    ...
    public static void sendIncidentText() {
    	System.out.println("Incident SMS");
        // Create a client for submitting to Nexmo
        String SMS_TEXT="There is an Incident in your Application!!!"+"\n"+"Check your CIS Incident";
        NexmoSmsClient client = null;
        try {
            client = new NexmoSmsClient(API_KEY, API_SECRET);
        } catch (Exception e) {
